	...
	<div class="row">
		<div class="col-8 col-content">
			<div class="tsd-panel tsd-typography">
				...
				<p><em>by Vytenis Urbonavičius</em></p>
				<p>This utility generates single <em>index.d.ts</em> file for whole NPM package.</p>
				<p>It allows creating a bundled <em>NPM</em> library packages without <em>TypeScript</em> sources and yet still keeping code suggestions wherever these libraries are imported.</p>
...
npm-dts <span class="hljs-keyword">generate</span>
				...
				<table>
					...
					<tbody><tr>
							...
							<td>Allows changing main <em>src</em> file from <em>index.ts</em> to something else.</td>
						</tr>
						<tr>
